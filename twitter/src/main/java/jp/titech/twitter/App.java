...
public class App {
	...
	public static void main( String[] args ) {
		...
		for (String screenName : screenNames) {
			...
			TwitterUser twitterUser = TweetBaseUtil.getTwitterUserWithScreenName(screenName);
			
			count++;
			control.startSearchMining(twitterUser);
			
			Log.getLogger().info("Creating ontology...");
			control.createOntology(twitterUser, 500, topic, count);
		}
	}
}
*/